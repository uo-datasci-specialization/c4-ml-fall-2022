...
## 3.1. Predicting a continuous outcome with the KNN algorithm (DIY)
...
# 5. Predicting a continuous outcome with the KNN algorithm (DIY)
...
# 6. Predicting a binary outcome with the KNN algorithm
