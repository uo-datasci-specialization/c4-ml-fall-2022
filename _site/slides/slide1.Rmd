...
- am married with two kids (6 and 9).
...
- Successful completion of the first three courses in EDS specialization (EDLD 651, EDLD 652, and EDLD  653) is required to enroll in this course. 

- Successful completion of an introductory and intermediate course in statistics (e.g., EDUC 614, EDUC 642) would be helpful and complimentary.

- If you have never taken a course on linear algebra and calculus, there are some notes to read on the website (Week 0). It may be useful to review them.
...
- Online office hours: 
  ...
  - Wednesday, 4 pm – 5 pm (Zoom)
  
  - by appointment
  
  - https://uoregon.zoom.us/j/6883665008?pwd=S1BkMTZhTk4weWZVSjUvQ2FVeGowQT09
...
- The HEDCO Learning Commons (https://learningcommons.uoregon.edu/) is located in Room 110 and equipped with Windows and macOS computer workstations, small and large study rooms. It is currently open from 9 am to 5 pm Monday – Friday.
...
- Four Homework Assignments
  ...
  - A total of four assignments will be delivered through Canvas
  
  - All homework assignment should be completed independently without any help from another person. You cannot discuss your work with other people in the class or outside of the class. 
  ...
  - The assignments will be available for one week after they are posted. You have to complete the assignments during this window. 
...
- Please create a Kaggle notebook if you don't have one.
